...
export default function AboutUs({ setCurrentPage }) {
  return (
    <main className="overflow-x-hidden pt-20 md:pt-20">
      {/* Hero Section */}
      <section className="relative min-h-[60vh] flex items-center justify-center py-16 px-6 md:px-20 bg-background">
        <div className="max-w-4xl mx-auto text-center">
          <span className="material-symbols-outlined text-6xl text-primary mb-4 block">auto_awesome</span>
      ...
      <section className="py-20 px-6 md:px-20 bg-surface">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="aspect-square bg-cream rounded-xl flex items-center justify-center text-6xl">
              🎂
            </div>
            <div>
      ...
      <section className="py-20 px-6 md:px-20 bg-background">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-headline-lg text-headline-lg text-on-background text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="bg-surface-container-lowest p-8 rounded-xl border border-outline-variant text-center shadow-sm hover:shadow-md transition-shadow"
              >
      ...
      <section className="py-16 px-6 md:px-20 bg-primary text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button className="px-8 py-4 bg-surface-container-lowest text-primary font-label-md text-label-md rounded-lg shadow-lg hover:bg-surface transition-colors">
            Fazer Pedido Agora
          </button>
        </div>
      </section>
